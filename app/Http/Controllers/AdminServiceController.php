...
class AdminServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::table('services')->insert(['name' => $data['name'], 'slug' => $slug, 'hero_heading' => $data['hero_heading'] ?? $data['name'], 'summary' => $data['summary'] ?? null, 'hero_description' => $data['hero_description'] ?? $data['summary'] ?? null, 'hero_image' => $heroImage, 'help_heading' => 'Where '.$data['name'].' Can Help', 'help_description' => 'Explore key areas where this laboratory service can support clinical decision-making.', 'help_cards' => json_encode([['heading' => 'Clinical Assessment', 'description' => 'Supports accurate testing and informed clinical decisions.'], ['heading' => 'Health Monitoring', 'description' => 'Helps monitor relevant health indicators over time.'], ['heading' => 'Screening Support', 'description' => 'Provides useful information for routine screening needs.'], ['heading' => 'Patient Care', 'description' => 'Helps guide practical patient-care decisions.']]), 'intro_heading' => 'Understanding '.$data['name'], 'intro_description' => $data['summary'] ?? 'Reliable laboratory testing tailored to support clinical assessment and patient care.', 'intro_bullets' => "Supports accurate clinical assessment.\nUses reliable laboratory testing methods.\nDesigned around practical clinical needs.", 'button_text' => $data['button_text'] ?? 'Book an Appointment', 'button_link' => $data['button_link'] ?? '/appointment', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
