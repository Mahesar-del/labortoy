...
<head>
    ...
    <title>Edit Home Hero | Lab Admin</title>
    <style>
        :root{--navy:#082942;--teal:#18bca9;--ink:#12314e;--muted:#6f879c;--line:#dce8f0}*{box-sizing:border-box}body{margin:0;background:#f2f7fa;color:var(--ink);font-family:Inter,Arial,sans-serif}.page{max-width:1120px;margin:0 auto;padding:34px 20px 60px}.top{display:flex;justify-content:space-between;align-items:center;margin-bottom:26px}.back{color:#2775ca;text-decoration:none;font-weight:700;font-size:14px}.title h1{margin:0 0 6px;font-size:28px}.title p{margin:0;color:var(--muted)}.card{display:grid;grid-template-columns:1.2fr .8fr;gap:28px;padding:30px;background:#fff;border:1px solid var(--line);border-radius:18px;box-shadow:0 12px 32px rgba(24,61,88,.08)}.form-title{margin:0 0 20px;font-size:18px}.field{margin-bottom:17px}.field label{display:block;margin-bottom:7px;font-size:13px;font-weight:750}.field small{display:block;margin-top:5px;color:var(--muted);font-size:11px}input,textarea{width:100%;padding:12px 13px;border:1px solid #cadbe6;border-radius:9px;color:var(--ink);font:inherit;font-size:14px;outline:none}textarea{min-height:108px;resize:vertical}input:focus,textarea:focus{border-color:var(--teal);box-shadow:0 0 0 3px rgba(24,188,169,.12)}.button-row{display:grid;grid-template-columns:1fr 1fr;gap:14px}.save{margin-top:8px;width:100%;border:0;border-radius:9px;padding:14px;background:linear-gradient(90deg,#069b8a,#1dbbaf);color:#fff;font-weight:800;font-size:14px;cursor:pointer}.preview{padding:20px;border-radius:14px;background:linear-gradient(135deg,#093b62,#0d887f);color:#fff;min-height:400px}.preview h2{margin:0 0 10px;font-size:25px;line-height:1.15}.preview p{color:#d0eef0;line-height:1.6;font-size:14px}.preview img{width:100%;height:170px;object-fit:cover;margin:15px 0;border-radius:10px;background:#d9e9ef}.preview-actions{display:flex;gap:9px;margin-top:20px}.preview-actions span{padding:10px 13px;border-radius:99px;background:#1fc1b8;font-size:12px;font-weight:700}.preview-actions span+span{background:transparent;border:1px solid rgba(255,255,255,.6)}.alert{padding:12px 14px;margin-bottom:18px;border-radius:9px;background:#e4faf5;color:#087b6d;font-size:13px;font-weight:700}.errors{padding:12px 14px;margin-bottom:18px;border-radius:9px;background:#fff1f1;color:#a32929;font-size:13px}@media(max-width:760px){.top{align-items:flex-start;gap:14px;flex-direction:column}.card{grid-template-columns:1fr;padding:20px}.preview{min-height:auto}.button-row{grid-template-columns:1fr}}
    </style>
</head>
<body>
    @php
