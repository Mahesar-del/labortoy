...
<style>
.dynamic-intro{background:#fff;padding:45px 0}.dynamic-intro__inner{align-items:stretch;display:grid;gap:70px;grid-template-columns:1.1fr .8fr;margin:auto;max-width:1440px;padding:0 7%}.dynamic-intro h2{color:#071e38;font:700 clamp(28px,3vw,40px) Arial;margin:0 0 20px}.dynamic-intro p,.dynamic-intro li{color:#182c3e;font:17px/1.7 Arial;text-align:justify}.dynamic-intro p{margin:0 0 22px}.dynamic-intro ul{margin:0;padding-left:22px}.dynamic-intro img{border-radius:18px;height:100%;min-height:360px;object-fit:cover;width:100%}@media(max-width:700px){.dynamic-intro{padding:10vw 0}.dynamic-intro__inner{gap:6vw;grid-template-columns:1fr;padding:0 7vw}.dynamic-intro img{min-height:250px;order:-1}}
</style>
