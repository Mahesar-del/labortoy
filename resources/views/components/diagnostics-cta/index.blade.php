...
<style>
    ...
    .diagnostics-cta { padding: 42px 7%; background: #fff; }
    .diagnostics-cta__container { width: 100%; max-width: 1320px; margin: 0 auto; }
    .diagnostics-cta__card { align-items: center; background: #0B2545; border-radius: 24px; color: #fff; display: flex; justify-content: center; min-height: 330px; overflow: hidden; padding: 42px 24px; position: relative; text-align: center; }
    ...
    @media (max-width: 600px) { .diagnostics-cta { padding: 28px; } .diagnostics-cta__card { border-radius: 18px; min-height: 300px; } .diagnostics-cta h2 { font-size: 22px; } .diagnostics-cta p { font-size: 12px; margin: 18px auto 24px; } .diagnostics-cta__button { font-size: 12px; padding: 12px 20px; } .diagnostics-cta__decoration { opacity: .55; } }
</style>
