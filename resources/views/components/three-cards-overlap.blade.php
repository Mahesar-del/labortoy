...
<style>
    ...
    .tco-icon { align-items: center; background: #0a2b55; border-radius: 9px; color: #fff; display: inline-flex; height: 62px; justify-content: center; margin-bottom: 23px; width: 62px; border: 1px solid rgba(255,255,255,0.4); }
    .tco-icon img { height: 50px; object-fit: contain; width: 50px; }
