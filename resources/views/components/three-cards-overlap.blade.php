...
<style>
    ...
    .tco-icon { align-items: center; background-image: url('{{ asset('images/rectangle.svg') }}'); background-size: contain; background-repeat: no-repeat; background-color: transparent; border: none; color: #fff; display: inline-flex; height: 62px; justify-content: center; margin-bottom: 23px; width: 62px; }
    .tco-icon img { height: 44px; object-fit: contain; width: 44px; }
    .tco-icon img[src*="dna.svg"] { transform: scale(1.4); }
