...
<head>
    ...
    <style>
        ...
        .assigned-tests{height:calc(100vh - 190px);min-height:420px;overflow-y:auto;overscroll-behavior:contain;padding:6px 14px 20px 0;scrollbar-width:thin;scrollbar-color:#19bba8 #dceaf2}
        .assigned-tests::-webkit-scrollbar{width:7px}.assigned-tests::-webkit-scrollbar-track{background:#dceaf2;border-radius:10px}.assigned-tests::-webkit-scrollbar-thumb{background:#19bba8;border-radius:10px}
        @media(max-width:800px){.assigned-tests{height:auto;min-height:0;max-height:65vh;padding-right:8px}}
    </style>
</head>
