...
<body>
    <section class="services-hero" aria-labelledby="services-hero-title">
        <div class="services-hero__background" style="background-image: url('{{ asset('images/provider-hero.jpg') }}');"></div>
        <div class="services-hero__overlay"></div>
    
        <div class="services-hero__container">
            <div class="services-hero__content">
                <h1 id="services-hero-title">Healthcare Provider<br>Services</h1>
                <p>Streamlined laboratory testing, fast turnaround times, and dedicated support designed specifically for healthcare providers and clinical partners.</p>
